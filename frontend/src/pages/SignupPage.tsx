                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-dark-700/80 text-white px-4 py-3 rounded-lg border ${errors.password ? 'border-red-500' : 'border-white/10'
                                            } focus:border-orange-500 focus:outline-none transition-colors`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        autoComplete="new-password"
                                        className={`w-full bg-dark-700/80 text-white px-4 py-3 rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-white/10'
                                            } focus:border-orange-500 focus:outline-none transition-colors`}
