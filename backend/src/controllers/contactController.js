...
const submitContactForm = asyncHandler(async (req, res) => {
  ...
  // Input validation — ApiError(message, statusCode)
  ...
  // Attempt to send email using nodemailer — degrade gracefully on failure
  try {
    ...
    logger.error(`Contact form email error: ${emailErr.message}`);
